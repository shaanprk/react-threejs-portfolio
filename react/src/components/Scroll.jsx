...
//     // States for hover, selection, position, rotation, and inspection
//     const [hovered, setHovered] = useState(false); // Is the scroll hovered
//     const [selected, setSelected] = useState(false); // Is the scroll selected
//     const [targetPosition, setTargetPosition] = useState([-0.4, 0.685, 1.5]); // Position on shelf
//     const [targetRotation, setTargetRotation] = useState([0, 0, 0]); // Default rotation
//     const [isCentered, setIsCentered] = useState(false); // Is the scroll centered
...
//         const intersects = raycaster.intersectObjects([scrollRef.current]);
//         if (intersects.length > 0) {
//             // Move scroll to center of the screen
//             setTargetPosition([0.39, 0, 4]);
//             setTargetRotation([0, Math.PI / 2, 0]);
//             setIsCentered(true);
//         } else {
//             // Return scroll back to shelf
...
//     // Listen for pointer movement and clicks
//     useEffect(() => {
...
//     // Animate position and rotation of scroll
//     useFrame(() => {
//         if (scrollRef.current) {
//             const [x, y, z] = scrollRef.current.position;
...
//             const [rx, ry, rz] = scrollRef.current.rotation.toArray();
