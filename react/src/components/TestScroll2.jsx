...
//     // console.log("[TestScroll2] pointer move", e);
//     updateRayCaster(e);
...
//       console.log("[TestScroll2] set cursor to pointer");
//     } else {
//       setHovered(false);
//       gl.domElement.style.cursor = "auto";
//       console.log("[TestScroll2] set cursor to auto");
//     }
//   };
...
const TestScroll2 = ({ page, isActive, onOpen }) => {
  ...
  }, [isActive, scrollSize, size, camera.fov, camera.aspect, camera.position.z, page]);
